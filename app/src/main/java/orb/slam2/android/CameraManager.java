...
import orb.slam2.android.MainActivity;
import orb.slam2.android.ErrorDialog;
...
public class CameraManager {
     ...
     */
    public CameraManager(MainActivity act) {
        this.activity = act;
    ...
    public void openCamera(int width, int height) {
        ...
        try {
            ...
            mImageReader.setOnImageAvailableListener(activity.imageAvailableListener, null);
...
//            camera2View.setRotation(mSensorOrientation);
    ...
    private void startPreview() {
        if (mCameraDevice == null || mPreviewSize == null || mImageReader == null) {
            return;
        }
        try {
...
//            mPreviewBuilder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
            ...
            SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(activity);
            String focus = sharedPreferences.getString("prefFocusLength", "1.0");
