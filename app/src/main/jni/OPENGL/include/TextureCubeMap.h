...
namespace vvision
{
    class CTextureCubeMap
    {
        ...
        void CreateTexture(GLenum target, uint32 width, uint32 height, GLint internal_format,
                           ...
                           GLint Swrap_mode = GL_CLAMP_TO_EDGE,//GL_CLAMP_TO_EDGE
                           GLint Twrap_mode = GL_CLAMP_TO_EDGE,//GL_CLAMP_TO_EDGE
...
//        void ActivateAndRefresh(GLenum target, void * data, GLsizei width, GLsizei height, GLint xoffset = 0, GLint yoffset = 0,GLint level = 0, GLenum host_format = GL_RGBA, GLenum host_type = GL_UNSIGNED_BYTE);
        void ActivateAndRefresh(GLenum target, void * data, GLsizei width, GLsizei height, GLint xoffset = 0, GLint yoffset = 0,GLint level = 0, GLenum host_format = GL_RGB, GLenum host_type = GL_UNSIGNED_BYTE);
