...
#include "../include/OffscreenRenderTarget.h"
...
namespace vvision
{
    ...
    bool COffscreenRenderTarget::Initialize(uint32 context_type, uint32 context_size)
    {
        ...
        if (context_type & kCONTEXT_COLOR)
        {
            ...
            m_pColor->CreateTexture(GL_TEXTURE_2D, m_iContextSize, m_iContextSize, GL_RGB,
                                    GL_UNSIGNED_BYTE, GL_RGB, NULL, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_LINEAR, true, 0, 0);
